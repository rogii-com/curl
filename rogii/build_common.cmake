...
if (WIN32)
    set(COMMON_BUILD_OPT ${COMMON_BUILD_OPT} -DCURL_USE_SCHANNEL=ON)
    set(COMMON_BUILD_OPT ${COMMON_BUILD_OPT} -DENABLE_UNICODE=ON)
else()
    set(COMMON_BUILD_OPT ${COMMON_BUILD_OPT} -DCURL_USE_SCHANNEL=OFF)
endif()
